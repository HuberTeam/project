...
class Up extends TagLib {
  protected $tags=array(
    ...
    public function _webuploadercss(){
        $str=<<<php
<link rel="stylesheet" href="__STATIC_FW__/webuploader/webuploader.css">
<link rel="stylesheet" href="__PUBLIC_CSS__/customup.css">
php;
        return $str;
    }
    // webuploader的js部分
    public function _webuploaderjs(){
        $str=<<<php
<script src="__STATIC_FW__/webuploader/webuploader.nolog.min.js"></script>
php;
        return $str;
    }
    /**
    ...
    {
        $url = isset($tag['url']) ? $tag['url'] : U('Content/ajax_uploadImages');
        $name = isset($tag['name']) ? $tag['name'] : 'file_name';
        $word = isset($tag['word']) ? $tag['word'] : '或将图片拖到这里，单次最多可选5张';
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        ...
        // swf文件路径
        swf: '__STATIC_FW__/webuploader/js/Uploader.swf',
...
<script type="text/javascript" src="__STATIC_FW__/ueditor1433/ueditor.config.js"></script>
<script type="text/javascript" src="__STATIC_FW__/ueditor1433/ueditor.all.js"></script>
