...
<div class="page-container">
	<form action="/demo/index.php/admin/Message/message" method="get">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius del"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="/demo/index.php/admin/Firm/add" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加公司</a> <button type="button" class="btn btn-primary radius send_message" onclick="send_message()"><i class="Hui-iconfont">&#xe600;</i> 发送站内信</button></span> <span class="r">共有数据：<strong><?php echo ($total); ?></strong> 条</span> </div>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				...
				<th width="100">公司签名</th>
				<th width="100">区域</th>
                <th width="100">行业</th>
                <th width="100">主体</th>
                <th width="100">产品</th>
                <th width="100">项目</th>
                <th width="100">添加公司成员</th>
                <th width="100">查看公司分组</th>
				<th width="100">编辑</th>
			</tr>
		</thead>
		<tbody>
		<?php if($company != ''): if(is_array($company)): foreach($company as $key=>$row): ?><tr class="text-c">
                ...
                <td><a href="/demo/index.php/admin/Member/index?cid=<?php echo ($row["id"]); ?>">查看公司成员</a></td>
                <td><a href="/demo/index.php/admin/Member/group_show?cid=<?php echo ($row["id"]); ?>">查看公司分组</a></td>
			...
			<?php else: ?>
			<tr><td colspan="7">没有数据</td></tr><?php endif; ?>
		</tbody>
	</table>
	</div><br>
